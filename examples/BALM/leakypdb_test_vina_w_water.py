...
for pdb_id in tqdm(pdb_ids):
    ...
    # rest of pipeline
    vina_process_lig_prot(ligand_file, receptor_file, complex_file, preserve_water=True, preserve_metal=True, csv_out_file='leakypdb_test_vina_w_water_data.csv')