...
for pdb_id in tqdm(pdb_ids):
    ...
    filename = download_pdb_file(pdb_id)
    # split the protein and ligand from the PDB file
    complex_file, receptor_file, ligand_file = pdb_to_prot_lig(pdb_id, filename, preserve_water=False,preserve_metal=True)
    # rest of pipeline
    vina_process_lig_prot(ligand_file, receptor_file, complex_file, preserve_water=False, preserve_metal=True, csv_out_file='leakypdb_test_vina_wo_water_data.csv')