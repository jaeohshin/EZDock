...
# This is to recalculate and recollect data for the ligands that had errors in the previous run, after fixing extract_chemgauss4 function
import glob
...
for ligand_file in all_mpro_ligands:
    ...
    oe_process_lig_prot(ligand_file, 
                        ...
                        preserve_water=True, 
                        preserve_metal=True, 
                        csv_out_file='mpro_oe_w_water_data_errors.csv')